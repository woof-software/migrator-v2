...
interface IComet {
    ...
    function supplyFrom(address from, address dst, IERC20 asset, uint amount) external;
    ...
    function withdrawTo(address to, IERC20 asset, uint amount) external;

    function withdrawFrom(address src, address to, IERC20 asset, uint amount) external;

    function approveThis(address manager, IERC20 asset, uint amount) external;
