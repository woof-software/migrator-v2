...
export declare namespace DataTypes {
  ...
  export type ReserveDataStruct = {
    ...
    variableBorrowIndex: PromiseOrValue<BigNumberish>;
    currentVariableBorrowRate: PromiseOrValue<BigNumberish>;
    __deprecatedStableBorrowRate: PromiseOrValue<BigNumberish>;
    lastUpdateTimestamp: PromiseOrValue<BigNumberish>;
    id: PromiseOrValue<BigNumberish>;
    liquidationGracePeriodUntil: PromiseOrValue<BigNumberish>;
    aTokenAddress: PromiseOrValue<string>;
    __deprecatedStableDebtTokenAddress: PromiseOrValue<string>;
    variableDebtTokenAddress: PromiseOrValue<string>;
    interestRateStrategyAddress: PromiseOrValue<string>;
    accruedToTreasury: PromiseOrValue<BigNumberish>;
    unbacked: PromiseOrValue<BigNumberish>;
    isolationModeTotalDebt: PromiseOrValue<BigNumberish>;
    virtualUnderlyingBalance: PromiseOrValue<BigNumberish>;
  };
...
export interface AavePoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [
      PromiseOrValue<BigNumberish>,
      DataTypes.EModeCategoryBaseConfigurationStruct
    ]
  ): string;
  encodeFunctionData(
...
export interface AavePool extends BaseContract {
  ...
  functions: {
    ...
    configureEModeCategoryBorrowableBitmap(
      id: PromiseOrValue<BigNumberish>,
      borrowableBitmap: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    configureEModeCategoryCollateralBitmap(
      id: PromiseOrValue<BigNumberish>,
      collateralBitmap: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
